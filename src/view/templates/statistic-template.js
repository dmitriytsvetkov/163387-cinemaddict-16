...
const createStatisticsTemplate = ({cardsData, dateFrom, dateTo, currentFilter}) => {
  ...
  return `<section class="statistic">
    ...
    <form action="https://echo.htmlacademy.ru/" method="get" class="statistic__filters">
      ...
      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-month" value="month" ${currentFilter === FILTER_TYPES.MONTH ? 'checked' : ''}>
